<tr valign="top">
    ...
    <td class="forminp">
        ...
        <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=upgrade-plugin&plugin=' . RY_WSI_PLUGIN_BASENAME), 'upgrade-plugin_' . RY_WSI_PLUGIN_BASENAME)); ?>">
