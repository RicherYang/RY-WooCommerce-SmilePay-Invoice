...
<div class="edit_address">
    ...
    <p class="form-field form-field-wide <?php echo esc_attr($field['id']) ?>_field">
        ...
        &lrm;
        <input type="number" class="hour" placeholder="<?php esc_attr_e('h', 'ry-woocommerce-smilepay-invoice'); ?>" name="<?=esc_attr($field['id']); ?>_hour" min="0" max="23" step="1" value="" pattern="([01]?[0-9]{1}|2[0-3]{1})" />:
        <input type="number" class="minute" placeholder="<?php esc_attr_e('m', 'ry-woocommerce-smilepay-invoice'); ?>" name="<?=esc_attr($field['id']); ?>_minute" min="0" max="59" step="1" value="" pattern="[0-5]{1}[0-9]{1}" />:
        <input type="number" class="second" placeholder="<?php esc_attr_e('s', 'ry-woocommerce-smilepay-invoice'); ?>" name="<?=esc_attr($field['id']); ?>_second" min="0" max="59" step="1" value="" pattern="[0-5]{1}[0-9]{1}" />
    </p>
    <?php
                    break;
                default:
