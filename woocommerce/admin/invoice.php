...
final class RY_WSI_WC_Admin_Invoice
{
    ...
    public function bulk_action_notices()
    {
        ...
        if ('ry_get_invoice' === $bulk_action) {
            ...
            /* translators: %s: count */
            $message = sprintf(_n('%s order issue invoice.', '%s orders issue invoice.', $number, 'ry-woocommerce-smilepay-invoice'), number_format_i18n($number));
    ...
    {
        $actions['ry_get_invoice'] = __('Issue invoice', 'ry-woocommerce-smilepay-invoice');
